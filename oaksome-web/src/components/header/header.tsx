                                ...
                                <div className="mega-section-right">
                                    <div className="mega-grid" style={{ gridTemplateColumns: 'repeat(5, 1fr)' }}>
                                        {categories.map((cat) => {
                                            ...
                                            return (
                                                <Link key={cat.id} href={{ pathname: '/gamme/[slug]', params: { slug } }} className="mega-item">
                        ...
                        <div className="mobile-menu-accordion-content">
                            <div className="mobile-menu-sub-grid">
                                {categories.map((cat) => {
                                    const slug = cat.slug || toSlug(cat.name);
                                    return (
                                        <Link key={cat.id} href={{ pathname: '/gamme/[slug]', params: { slug } }} className="mobile-menu-sub-item" onClick={() => setMobileMenuOpen(false)}>
                                            {cat.image_128 && <img src={imageSrc(cat.image_128)} alt={cat.name} />}
                                            <span>{cat.name}</span>
                                        </Link>
                                    );
