...
export async function getHomepageInspirations(lang?: string): Promise<Result<HomepageInspirationsData>> {
  const params = lang ? { lang } : undefined
  return apiGet<HomepageInspirationsData>('/homepage-inspirations', params, { revalidate: 3600 })
}
