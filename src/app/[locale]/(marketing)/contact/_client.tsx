                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input type="text" name="firstName" placeholder={t('ph_first_name')} value={form.firstName} onChange={handleChange} />
                    </div>
                    <div className="form-group">
                      <label>{t('label_last_name')}</label>
                      <input type="text" name="lastName" placeholder={t('ph_last_name')} value={form.lastName} onChange={handleChange} />
                    </div>
                  </div>
                  <div className="form-row">
                    <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <textarea name="message" placeholder={t('ph_message')} value={form.message} onChange={handleChange}></textarea>
                  </div>
                  <div className="form-group">
